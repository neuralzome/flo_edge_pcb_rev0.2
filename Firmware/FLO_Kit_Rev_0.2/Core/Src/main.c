...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	flo_edge_main();
	  //HAL_GPIO_TogglePin(GPIOA, FAN_PWM_Pin);
	  //HAL_GPIO_WritePin(GPIOA,FAN_PWM_Pin,GPIO_PIN_SET);
//	  if(HAL_GPIO_ReadPin(GPIOA, BOOT_MODE_Pin))
//	  {
...
////	  HAL_GPIO_TogglePin(GPIOB, VOLUME_UP_Pin);
////	  HAL_GPIO_TogglePin(GPIOB, VOLUME_DOWN_Pin);
////	  HAL_GPIO_TogglePin(GPIOB, POWER_Pin);
//	  HAL_Delay(100);
  }
  /* USER CODE END 3 */
}
